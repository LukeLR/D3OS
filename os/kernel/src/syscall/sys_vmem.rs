...
pub fn sys_map_user_heap(size: usize) -> isize {
    ...
    let code_areas = process.kernelmode_address_space.find_vmas(VmaType::Code);
    ...
    process.kernelmode_address_space.map(heap_area.range(), MemorySpace::User, PageTableFlags::PRESENT | PageTableFlags::WRITABLE | PageTableFlags::USER_ACCESSIBLE, VmaType::Heap, "");
