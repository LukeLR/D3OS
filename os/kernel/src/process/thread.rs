...
impl Thread {
    ...
    pub fn load_application(elf_buffer: &[u8], name: &str, args: &Vec<&str>) -> Arc<Thread> {
        ...
        elf.program_headers
            ...
            .for_each(|header| {
                ...
                let frames = process.kernelmode_address_space.alloc_pf_for_vma(&vma);
                if frames.is_none() {
                ...
                let res = process.kernelmode_address_space.map_pfr_for_vma(
                    &vma,
                    frames,
        ...
        let env_frames = process.kernelmode_address_space.alloc_pf_for_vma(&env_vma)
    ...
    pub fn new_user_thread(
        ...
        let highest_stack_vma = parent.kernelmode_address_space
            .iter_vmas()
        ...
        parent.kernelmode_address_space.map_partial_vma(
            &user_stack_vma,
